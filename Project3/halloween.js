...
const stringConnectionY = bowY - .2;
...
function GenerateString()
{
	...
	if (arrowY > bowY + 1) //make string flat if arrow is shot
		points.push(vec2(0, flatString));
	else //pull string back with arrow
		points.push(vec2(0, arrowY - stringConnectionY - arrowLength));
	points.push(vec2(stringLoc, flatString));
...
{
	modelViewMatrix = mat4();
	modelViewMatrix = mult(modelViewMatrix, translate(0, stringConnectionY, 0));
